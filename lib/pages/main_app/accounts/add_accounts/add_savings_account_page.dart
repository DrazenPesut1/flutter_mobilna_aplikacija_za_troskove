...
class AddSavingsAccountPage extends StatefulWidget{
  ...
  @override
  State<AddSavingsAccountPage> createState() => _AddSavingsAccountPageState();
}
...
class _AddSavingsAccountPageState extends State<AddSavingsAccountPage>{
  ...
  void openIconPicker() async {
    ...
    if (icon != null) {
      setState(() {
        selectedIcon = Icon(icon.data, color: selectedColor, size: 33.0,);
      });
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  AccountTextField(hint: "Card, cash...", textEditingController: accountNameController),
